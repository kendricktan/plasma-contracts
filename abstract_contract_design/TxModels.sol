...
library NormalTxModel {
    ...
    function decode(bytes memory _tx) internal pure returns (Tx memory) {
        // dummy implement
        ...
        NormalTxOutputModel.TxOutput memory dummyTxOut = NormalTxOutputModel.TxOutput(
            1, NormalTxOutputModel.TxOutputData(10, address(0), address(0)));
